...
as_user yay -Syu --noconfirm --needed --answerdiff=None --answerclean=None google-chrome
...
REPO_GITHUB="https://github.com/Zerotii/ShorinArchExperience-ArchlinuxGuide.git"
